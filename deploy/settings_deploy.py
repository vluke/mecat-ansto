...
'mecat.vbl_auth.VblGroupProvider',
...
AUTH_PROVIDERS = (
('vbl', 'NBI', 'mecat.vbl_auth.Backend'),
...
SYSTEM_LOG_MAXBYTES = 4000000
MODULE_LOG_MAXBYTES = 4000000
...
VBLTARDISINTERFACE = 'https://versi-vbl.nbi.ansto.gov.au/TardisInterface/VBLTardisInterface.wsdl'
VBLPROXY = {'https': 'www-proxy.nbi.ansto.gov.au:3128'}
