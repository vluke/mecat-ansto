...
urlpatterns = patterns('',
                       ...
                       (r'^experiment/register/$', 'mecat.register.'),
                       #(r'^download/datafile/(?P<datafile_id>\d+)/$', 'mecat.download.download_datafile'),
                       #(r'^download/experiment/(?P<experiment_id>\d+)/(?P<comptype>[a-z]{3})/$', 'mecat.download.download_experiment'),
                       #(r'^download/datafiles/$', 'mecat.download.download_datafiles'),
                       (r'^rif_cs/', no_view),
